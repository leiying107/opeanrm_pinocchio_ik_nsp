...
Example:
    ros2 run openarm_pinocchio_nsp home --side right
    ros2 run openarm_pinocchio_nsp home --side left --time 3.0
"""
...
from openarm_pinocchio_nsp.move_joints import MoveJoints, sides_from_arg
