...
Examples:
    ros2 run openarm_pinocchio_ik move_joints --side right --deg 0,-30,0,90,0,45,0
    ros2 run openarm_pinocchio_ik move_joints --side both --joints 0,0,0,0,0,0,0 --time 3.0
"""
